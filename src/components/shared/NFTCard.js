import { offerNFTForLoaning, loanContractAddress } from '../../utils/web3';
import { useState } from 'react';

export default function NFTCard ({ nfts, marketplace }) {
    const [time, setTime] = useState(5000)
    const loanNFT = async (contractAddress, tokenID) => {
        await offerNFTForLoaning(contractAddress, loanContractAddress, tokenID, time.toString())
    }
    return (
        marketplace ? (
            <div class="bg-white">
                            ...
                            <div key={index}>
                                ...
                                <div class="mt-4 flex justify-between">
                                    <div>
                                        ...
                                        {/* <input type="number" name="time" value={time} onChange={(e) => setTime(e.target.value)} placeholder='Time to loan (seconds: default 5000s)' /> */}
                                        {/* <button
